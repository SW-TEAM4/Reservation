...
public interface SellerPageMapper {
   ...
   // 숙소 수정
    Map<String, Object> getLodInformation(int lodIdx);                            // 숙소정보 가져오기
   List<String>         getLodService(int lodIdx);                               // 숙소 서비스 가져오기
   void                 UpdateLod(LodRegisterDTO dto);                           // 숙소정보 Update
   void                 deleteLodMapper(int lod_idx);                            // 숙소매핑서비스 전체delete
